    ...
    return (
            <div className="flex gap-x-44">
                <div className="flex items-center gap-x-1">
                    ...
                    <span className="text-sm font-semibold text-text-color cursor-pointer">TÜM KATEGORİLER</span>
                </div>
                <div className="flex-1">
                    <ul className="flex gap-x-4 text-sm">
                        <li>
                            <a href="#" className="text-text-color font-semibold hover:text-primary-color">Kadın</a>
                        </li>
                        <li>
                            <a href="#" className="text-text-color font-semibold hover:text-primary-color">Erkek</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#" className="text-text-color font-semibold hover:text-primary-color">Kozmetik</a>
                        </li>
                        <li>
